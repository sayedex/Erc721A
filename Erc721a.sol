...
contract ApesUnshaved is IERC721A { 
    ...
    uint256 public constant MAX_SUPPLY = 970;
    uint256 public MAX_FREE = 666;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.001 ether;

    string private constant _name = "Apes Unshaved";
    string private constant _symbol = "APEUNSHAVED";
    string private _baseURI = "QmXSverXvDtSgKaCqmtioPCrK4qWmcaUHVbTNCmbEBeVJd";
